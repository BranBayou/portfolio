          ...
          <div key={data.index} className={`flex flex-col sm:flex-row gap-8 h-full`}>
            ...
            <div className="w-full sm:w-1/2 flex flex-col">
              ...
              <div className="flex gap-6">
                <a href={data.FaGithub} className="flex hover:text-black hover:cursor-pointer items-center gap-2 text-darkt">
                  <FaGithub className="text-blue-500" /> Code
                </a>
                <a href={data.liveDemo} className="flex hover:text-black hover:cursor-pointer items-center gap-2 text-darkt">

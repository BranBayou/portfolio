          ...
          <div className="">
            ...
            <div>
              ...
              <div className="flex gap-3 my-2">
                <button type="button" className="bg-darkt border border-gray-500 px-3 rounded-3xl">{data.stack[0]}</button>
                <button type="button" className="bg-darkt border border-gray-500 px-3 rounded-3xl">{data.stack[1]}</button>
                <button type="button" className="bg-darkt border border-gray-500 px-3 rounded-3xl">{data.stack[2]}</button>
              </div>
            </div>
